...
var xScale = d3
    .scaleBand()
    .domain(DATA.map(function (dataPoint) { return dataPoint.month; }))
    .range([0, 420])
    .padding(0.2)
    .align(0.79);
var yScale = d3
...
var bars = container
    ...
    .attr('height', function (data) { return 300 - yScale(data.value); })
    .attr('y', function (data) { return yScale(data.value); })
    .attr('x', function (data) { return xScale(data.month); });
